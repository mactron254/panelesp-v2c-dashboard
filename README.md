...
- Ultima estable: ver `STABLE_VERSION`.
- Cada version vive en `versions/vX.Y.Z`.
- No borrar versiones antiguas.
- Crear nueva version: `tools/new-version.ps1`.
- Marcar estable: `tools/set-stable-version.ps1`.
- Primero se valida la app normal completa. Variantes por pantalla se crearan despues.

Para publicar en GitHub: [`docs/github.md`](docs/github.md).
