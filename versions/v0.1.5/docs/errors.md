...
## 2026-06-26 - tools/new-version.ps1 falla copiando demos del vendedor

Error:

Copy-Item no puede encontrar parte de una ruta profunda dentro de demos del vendedor: esp_brookesia_image_large_app_launcher_default_112_112.png.

Causa:

El script copia toda la raiz del proyecto. Las carpetas demo del vendedor contienen rutas profundas y assets que pueden fallar en Windows durante copia recursiva.

Solucion aplicada:

- Eliminada carpeta parcial versions/v0.1.5 creada por el intento fallido.
- Creada versions/v0.1.5 copiando directamente desde versions/v0.1.4.
- Actualizado VERSION raiz y versions/v0.1.5/VERSION a 0.1.5.
- No se toca STABLE_VERSION.

Estado:

Resuelto para v0.1.5. Pendiente mejorar tools/new-version.ps1 para excluir demos/vendor pesados o usar copia robusta.
